                ...
                <form role="form" method="POST" action="{{ route('student.add_leave') }}">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="leave_reason" placeholder="Enter Reason for Leave" name="leave_reason" value="{{ old('leave_reason') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control pull-right" id="leave_range" name="leave_range"  value="{{ old('leave_range') }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" placeholder="Enter Description" name="leave_description">{{ old('leave_description') }}</textarea>
                        </div>
                    </div>
